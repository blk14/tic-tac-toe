...
int fill (char a[6][6]) {
	...
	for(i=0; i<6; i+=2){
		for(j=0; j<6; j+=2){
			...
			if((a[i][j] == '_') && ((a[i][j-2] == '0' && a[i][j+2] == '_') || (a[i][j+2]=='0' && a[i][j-2] == '_') || 
				(a[i-2][j]=='0' && a[i+2][j] == '_')
			 || (a[i+2][j]=='0' && a[i-2][j] == '_') || (a[i-2][j-2]=='0' && a[i+2][j+2] == '_')))
				{
	...
	for(i=0; i<6; i+=2){
		for(j=0; j<6; j+=2){
			...
			if((a[i][j] == '_') && (a[i][j-2] == '0' || a[i][j+2]=='0' || a[i-2][j]=='0' || a[i+2][j]=='0' || a[i-2][j-2]=='0')){
				a[i][j] = '0';
				return 1;
